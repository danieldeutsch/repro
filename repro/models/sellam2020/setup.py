...
class Sellam2020SetupSubcommand(BuildDockerImageSubcommand):
    ...
    def add_subparser(self, model: str, parser: argparse._SubParsersAction):
        ...
        self.parser.add_argument(
            "--not-bleurt-20",
            action="store_true",
            help="Indicates the BLEURT-20 model should *not* be downloaded",
        )
        ...
        self.parser.add_argument(
            "--bleurt-20-d12",
            action="store_true",
            help="Indicates the BLEURT-20-D12 model should be downloaded",
        )
        self.parser.add_argument(
            "--bleurt-20-d6",
            action="store_true",
            help="Indicates the BLEURT-20-D6 model should be downloaded",
        )
        self.parser.add_argument(
            "--bleurt-20-d3",
            action="store_true",
            help="Indicates the BLEURT-20-D3 model should be downloaded",
        )
    ...
    def run(self, args):
        build_args = {
            ...
            "BLEURT_20": "false" if args.not_bleurt_20 else "true",
            ...
            "BLEURT_20_D12": "true" if args.bleurt_20_d12 else "false",
            "BLEURT_20_D6": "true" if args.bleurt_20_d6 else "false",
            "BLEURT_20_D3": "true" if args.bleurt_20_d3 else "false",
        }
        build_image(
